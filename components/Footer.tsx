...
const navigation = {
  ...
  social: [
    {
      name: 'Facebook',
      href: 'https://facebook.com/microcrop',
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/microcrop',
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'Twitter',
      href: 'https://twitter.com/microcrop',
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    {
      name: 'LinkedIn',
      href: 'https://linkedin.com/company/microcrop',
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
    ...
    {
      name: 'YouTube',
      href: 'https://youtube.com/@microcrop',
      icon: (props: JSX.IntrinsicAttributes & SVGProps<SVGSVGElement>) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
          <path
            fillRule="evenodd"
